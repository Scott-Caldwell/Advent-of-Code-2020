...
namespace AdventOfCode2020.Tests.Puzzles.Day02.Part02
{
    public class Day02Part02Tests : PuzzleTestBase
    {
        [Theory]
        [InlineData(new[] { "1-3 a: abcde", "1-3 b: cdefg", "2-9 c: ccccccccc" }, "1")]
        public async Task GivenValidInput_ReturnsCorrectSolution(string[] input, string expected)
        {
            ...
            var uut = new AdventOfCode2020.Puzzles.Day02.Part02.Puzzle(inputProvider);
