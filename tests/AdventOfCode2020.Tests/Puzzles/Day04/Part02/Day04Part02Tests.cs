...
namespace AdventOfCode2020.Tests.Puzzles.Day04.Part02
{
    public class Day04Part02Tests : PuzzleTestBase
    {
        [Theory]
        [InlineData(new[]
        {
...
eyr:2022",
        ...
        public async Task GivenValidInput_ReturnsCorrectSolution(string[] input, string expected)
        {
            ...
            var uut = new AdventOfCode2020.Puzzles.Day04.Part02.Puzzle(inputProvider);
